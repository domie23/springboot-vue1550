...
<div class="section1">
    ...
    <div class="table">
        <table class="layui-hide" id="product_type" lay-filter="product_type"></table>
...
<script src="../../js/axios.min.js"></script>
    ...
    layui.use(['element', 'layer', 'util'], function () {
        ...
        let url = BaseUrl + '/api/product_type/get_list?like=0'
        ...
        if (user_group == "管理员" || $check_action('/product_type/table', 'del') || $check_action('/product_type/view', 'del')) {
            deletes.style.display = "block"
        }
        if (user_group == "管理员" || $check_action('/product_type/table', 'add') || $check_action('/product_type/view', 'add')) {
            add.style.display = "block"
        }
        if (user_group == "管理员" || $check_action('/product_type/view', 'get') || $check_action('/product_type/view', 'set')) {
            detail_flag = true;
        }
 ...
 function open_tip(arr) {
    ...
    ,
        ...
        open_tip(res.result.list);
            ...
            if (user_group == "管理员" || $check_pay('/product_type/table')) {
                for (var i = 0; i < res.result.list.length; i++) {
                    res.result.list[i].check_pay = true
                }
            }
            if (user_group == "管理员" || $check_action('/product_type/view', 'set') || $check_action('/product_type/view', 'get')) {
                for (var i = 0; i < res.result.list.length; i++) {
    ...
    ,
        ...
        table.on('tool(product_type)', function (obj) {
            var data = obj.data;
        if (obj.event === 'detail')
        {

                            window.location.href = "./view_add.jsp?" + data.product_type_id;
                    }
        ...
        let resetSelect = []
        //下拉框重置/Reset参数
        fun('product_type', BaseUrl + '/api/product_type/del', 'product_type_id', request, resetName, resetSelect        )
